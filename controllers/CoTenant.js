...
const ThisModel         =      mongoos.model('CoTenant');
const Helper            =      require("../middleware/helper");
var nodemailer          =      require('nodemailer');

const create = async (req, res) => {
  // #swagger.tags = ['CoTenant']
  /*
    #swagger.parameters['body'] = {
      in: 'body', 
      '@schema': { 
        "required": ["tenant_id","name","age","relation"], 
        "properties": { 
          "tenant_id": { 
            "type": "string",
            "description":"Take Author _id with role Tenant "
          },
          "name": { 
            "type": "string",
          },
          ...
          "relation": { 
            "type": "string",
            "description":"Take Relation off _id "
          },
        } 
      } 
    }
...
const list = async (req, res) => {
  ...
  //  #swagger.parameters['tenant_id'] = {in: 'query',type:'string',description:"Take Author _id with role Tenant "}
  ...
  try{
      ...
      let query={}
      query['tenant_id'] = {$eq:req.query.tenant_id}

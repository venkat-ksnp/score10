...
const ThisModel         =      mongoos.model('BankDetails');
const Helper            =      require("../middleware/helper");
var nodemailer          =      require('nodemailer');

const create = async (req, res) => {
  // #swagger.tags = ['BankDetails']
  /*
    #swagger.parameters['body'] = {
      in: 'body', 
      '@schema': { 
        "required": ["author_id","account_type","account_holder_name","bank_name","ifsc_code"], 
        "properties": { 
          "author_id": { 
            "type": "string",
            "description":"_id of Authors (role lanlord)",
          },
          "account_type": { 
            "type": "string",
            "enum": ["Saving","Current"],
